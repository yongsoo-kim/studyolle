...
public class StudyService {
    ...
    public Study getStudyToUpdateTag(Account account, String path) {
        //In JPA, "...StudyWithTags..." parts will be ignored.
        //That means, this method is same as "findByPath"
    ...
    public void startRecuit(Study study) {
        study.startRecruit();
    }
    public void stopRecuit(Study study) {
        study.stopRecruit();
    }
    ...
    public void remove(Study study) {
        if(study.isRemovable()){
            ...
            throw new IllegalArgumentException("스터디를 삭제 할수 없습니다.");
        }
    }
